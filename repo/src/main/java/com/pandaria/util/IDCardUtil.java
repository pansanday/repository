...
public final class IDCardUtil {
     ...
     * @return 15位身份证有效性
     * @throws Throwable 身份证错误
     */
    private static String fixPersonIDCodeWithCheck(String personIDCode) throws Throwable {
     ...
     * @return 十八位身份证号码
     */
    private static String fixPersonIDCodeWithoutCheck(String personIDCode) {
        if (personIDCode == null || personIDCode.trim().length() != 15)
            throw new RuntimeException("输入的身份证号不足15位，请检查");
     ...
     */
    private static String getFixedPersonIDCode(String personIDCode) throws Throwable {
     ...
     */
    private static Sex getGenderFromPersonIDCode(String identity) throws Throwable {
        String id = getFixedPersonIDCode(identity);
